...
public interface ActorMapper
{
    ...
    * @return Actor表
    */
    public Actor selectActorByFirstNameAndLastName(@Param("firstName")String firstName,@Param("lastName")String lastName);
    ...
    */
    public int deleteActorByFirstNameAndLastName(@Param("firstName")String firstName, @Param("lastName")String lastName);
